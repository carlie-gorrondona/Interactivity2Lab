...
const changeButtonBackgroundColorToOriginalColor = () => {

    sayHelloButton.style.backgroundColor = "#EFEFEF";
    sayHelloButton.style.color = "black";
}

sayHelloButton.addEventListener("mouseout", changeButtonBackgroundColorToOriginalColor);
...
const getRequest = () => {
    ...
    axios.get("http://localhost:3000/query-test/?string=Why???")
        .then(response => {
